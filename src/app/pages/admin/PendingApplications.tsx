                ...
                <article key={student.id} className="space-y-4 p-5">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div className="rounded-xl bg-slate-50 p-3">
                      <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Strand</p>
                      <p className="mt-1 font-semibold text-slate-900">{student.strandApplied}</p>
                    </div>
                    <div className="rounded-xl bg-slate-50 p-3">
                    ...
                    <div className="rounded-xl bg-slate-50 p-3">
                      ...
                      <p className="mt-1 font-semibold text-slate-900">{student.currentStatus}</p>
                    </div>
                  </div>

                  {isApproved ? (
                    <p className="rounded-xl bg-slate-50 px-4 py-3 text-center text-xs font-semibold text-slate-500">
                      Monitoring only
                    </p>
                  ) : (
                    <button

...
export function AdminLayout() {
  ...
  // Restricted navigation for Regular Admin
  const navItems = [
    ...
    { path: "/registrar/enrollment", label: "Enrollment Management", icon: UserCheck },
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-blue-200 text-xs">Registrar Portal</p>
            </div>
          </div>
        </div>
